...
private:
	...
	inline const static auto MS_LOGGER_NAME = global::g_config_yaml["log"]["logger-name"].as<std::string>();
	inline const static auto MS_FILENAME = global::g_config_yaml["log"]["filename"].as<std::string>();
	inline const static auto MS_HOUR = global::g_config_yaml["log"]["hour"].as<int>();
	inline const static auto MS_MINUTE = global::g_config_yaml["log"]["minute"].as<int>();
};
